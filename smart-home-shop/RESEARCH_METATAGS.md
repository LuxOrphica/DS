...
5. **Сроки:** 2-3 дня разработки, опциональное ручное заполнение top товаров
6. **Важно:** Schema.org обязателен для Google Rich Results
...
✅ Admin UI для SEO редактирования (if time)
✅ Ручное заполнение top 50-100 товаров (if владелец согласен)
```
